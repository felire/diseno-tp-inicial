...
public class Interfaz extends JPanel implements ActionListener{
	...
	public Interfaz(App aplicacion){
		...
		JLabel textoDia1 = new JLabel("Dia: ");
		textoDia1.setVisible(true);
		JLabel textoMes1 = new JLabel("Mes: ");
		textoMes1.setVisible(true);
		JLabel textoAnio1 = new JLabel("Año: ");
		textoAnio1.setVisible(true);
		this.add(texto1);
		this.add(combo1);
		this.add(texto2);
		this.add(combo2);
